...
\begin{neuralnetwork}[height=1,maintitleheight=1cm,layertitleheight=2.5cm, layerspacing=50]
  ...
  \hiddenlayer[count=4, title={}, bias=True, text=\texthiddenb]
  \linklayers
  ...
  % draw dots
    ...
    \draw [->,>=stealth,gray] (L3-1) -- node [black,midway,above] {$\hat{y}_1=g(z_{3,1})$} +(2,0);
    \draw [->,>=stealth,gray] (L3-2) -- node [black,midway,above] {$\hat{y}_2=g(z_{3,2})$} +(2,0);
\end{neuralnetwork}
